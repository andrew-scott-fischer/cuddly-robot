...
pub fn wallet_platform_system_status(drone_build_info: &DroneBuildInfo) -> DroneStatus {
    ...
    // let build_stage;
    // let test_stages = vec![];
    // let notify_success_stage;
    // let notify_failure_stage;

    // for stage in drone2_stages {
    //     if stage.drone_stage.name == "wallet-platform-build-tests" {
    //         build_stage = stage;
    //     } else if test_re.is_match(&stage.drone_stage.name) {
    //         test_stages.push(stage);
    //     } else if stage.drone_stage.name == "wallet-platform-report-test-failure" {
    //         notify_failure_stage = stage;
    //     } else if stage.drone_stage.name == "wallet-platform-report-test-success" {
    //         notify_success_stage = stage;
    //     } else {
    //         panic!("Unaccounted for drone2 stage.");
    //     }
    // }

    // if build_stage.drone_stage.exit_code == 137
    //     || test_stages.iter().fold(false, |acc, stage| {
    //         if stage.drone_stage.exit_code == 137 {
    //             return true;
    //         } else {
    //             return acc;
    //         }
    //     })
    //     || notify_failure_stage.drone_stage.exit_code == 137
    //     || notify_success_stage.drone_stage.exit_code == 137
    // {
    //     SystemStatus {
    //         status: DroneStatus::Killed,
    //         started: drone_build_info.build_info.timestamps.started,
    //         stopped: drone_build_info.build_info.timestamps.finished,
    //     }
    // } else if build_stage.drone_stage.exit_code == 78
    //     || test_stages.iter().fold(false, |acc, stage| {
    //         if stage.drone_stage.exit_code == 78 {
    //             return true;
    //         } else {
    //             return acc;
    //         }
